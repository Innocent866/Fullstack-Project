  ...
  return (
    <main className="container pt-5">
      <div className='row justify-content-between align-items-center pb-4'>
        ...
        <button className="btn btn-primary btn-lg my-2"><Link to='New' className='text-dark text-decoration-none'>+ New Users</Link></button>
        <button className="btn btn-primary btn-lg my-2"><Link to='All' className='text-dark text-decoration-none'>All Users</Link></button>
        </div>
        </div>
